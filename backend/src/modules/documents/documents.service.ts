...
<body>
  <div class="page">
    <div class="header">
      <div class="logo">منصة <span>دوبا<br/>ووك</span></div>
    ...
    <div class="footer">
      ...
      <div style="text-align:left; direction:ltr; font-size:11px; color:#888;">
        <p>Generated by Dopa Work Platform</p>
        <p>This document is system-generated and valid without a physical stamp.</p>
      </div>
    </div>

    <p class="watermark">هذه الوثيقة صادرة بصورة رقمية من منصة دوبا ووك — Dopa Work © ${new Date().getFullYear()}</p>
  </div>
</body>
</html>`;
